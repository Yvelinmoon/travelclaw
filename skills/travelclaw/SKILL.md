...
3. **Can combine 2-3 different sources** for creative fusion (e.g., "Tang Dynasty + Cyberpunk", "Byzantine art + 1920s Art Deco")
...
**Response Format (JSON only):**
{
  ...
  "cultural_roots": "MUST specify exact sources: e.g., 'Tang Dynasty China + Cyberpunk aesthetic', 'Byzantine religious art + 1920s Art Deco', 'Studio Ghibli animation style'",
...
- `cultural_roots`: Inspiration sources (e.g., "Tang Dynasty + Cyberpunk")
...
**Example Output:**
```
// For a Tang Dynasty + Cyberpunk world:
"Tang Dynasty court aesthetics, neon-lit atmosphere, golden dragon motifs mixed with holographic interfaces, @{character_name}, at Celestial Data Palace, Tang Cyberpunk aesthetic, elegant flowing robes with LED embroidery, high quality, detailed, artistic composition"
