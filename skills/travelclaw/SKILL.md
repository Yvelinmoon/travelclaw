...
5. **Dialogue** — Add 1-2 manga-style speech bubbles with dialogue(quote in "") between characters, naturally integrated to enhance storytelling (simple but meanningful,1~2 short sentence), keep clear in the image.
