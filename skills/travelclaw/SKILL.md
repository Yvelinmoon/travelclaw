...
**Add world art style and worldview background description to {world_context}**
...
**Output in a simple code block, no buttons:** ' 🚩 {round} / 5 stops, continue exploring?' (keep the format of stop counting, the guide text is changable)
